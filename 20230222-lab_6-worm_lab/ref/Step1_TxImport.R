...
write.table(Txi_gene$counts, file.path(wd, 'data/lab_6', 'Txi_gene_counts.csv'),
...
write.table(Txi_gene$abundance, file.path(wd, 'data/lab_6', 'Txi_gene_abundance.csv'),
            quote=FALSE, col.names=TRUE, row.names=TRUE, sep=',')
